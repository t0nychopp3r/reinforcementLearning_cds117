...
def save_results(name, initial_observation, final_q_table, episode_rewards, episode_water_resources,
    ...
    np.savetxt(f"{folder_name}/observation.txt", initial_observation, fmt="%s")
